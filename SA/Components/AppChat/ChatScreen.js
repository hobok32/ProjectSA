...
export default class ChatScreen extends Component {
    ...
    renderRow = ({ item }) => {
        return (
            <View styles={{
                ...
                <Text style={{ color: 'white', padding: 7, fontSize: 16, alignSelf: item.from === User.phone ? 'flex-end' : 'flex-start', }}>
                    {item.message}
                </Text>
                <Text style={{ color: 'lavender', padding: 3, fontSize: 12, alignSelf: item.from === User.phone ? 'flex-end' : 'flex-start', }}>
    ...
    render() {
        return (
            <View style={{ flex: 1 }}>
                <FlatList
                    style={{ height: 300, padding: 10, backgroundColor: 'pink' }}
                ...
                <View style={{ flex: 1, flexDirection: 'row' }}>
                    ...
                    <TouchableOpacity onPress={() => this.sendMessage()}>
                        <Text style={{ padding: 5, margin: 5, textAlign: 'center' }}>SEND</Text>
                    </TouchableOpacity>
